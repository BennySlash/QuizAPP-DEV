(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "@tsparticles/basic", "@tsparticles/interaction-external-trail", "./options.js"], factory);
    }
    ...
    async function loadFireflyPreset(engine, refresh = true) {
        ...
        await engine.addPreset("firefly", options_js_1.options, refresh);
    }
